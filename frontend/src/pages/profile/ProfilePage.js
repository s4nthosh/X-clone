...
import useUpdateProfileUser from "../../hooks/useUpdateProfileUser"
					...
					{!isLoading && !isRefetching && user && (
						<>
							...
							<div className='relative group/cover'>
								<img className='h-52 w-full object-cover' src={coverImg || user?.coverImg || "/cover.png"} alt="b"/>
								{isMyProfile && (
									<div
								...
								<div className='avatar absolute -bottom-16 left-4'>
									<div className='w-32 rounded-full relative group/avatar'>
										<img src={profileImg || user?.profileImg || "/avatar-placeholder.png"} alt="profile_img" />
